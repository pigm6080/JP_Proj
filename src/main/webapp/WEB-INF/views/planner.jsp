			...
			<nav class="nav_t">
				<div>
					...
					<div class="nav__list">
						...
						</a> <a href="/planner/home" class="nav__link collapse active"> <ion-icon
	...
	<section>
		<div class="them_main">
			<div class="them_title">
				<h1>Welcom</h1>
				<p>${principal.getName()}! 안녕하세요</p>
			</div>
			<div class="them_subtitle">
				<h2>
					<span class="them_subtitle_span1">P</span>를 위한 <span
						class="them_subtitle_span2">여행플래너</span>에 <br />오신 것을 환영합니다.
				</h2>
			</div>
